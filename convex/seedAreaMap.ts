...
export default internalMutation(async (ctx) => {
  ...
  const site3333 = await ctx.db.insert("sites", {
    accountNumber: "3333",
    name: "Bosch Security Campus - Bangalore",
    description: "Main security monitoring facility in Bangalore",
  ...
  const site2222 = await ctx.db.insert("sites", {
    accountNumber: "2222",
    name: "Secondary Security Site - Electronics City",
    description: "Warehouse and server facility in Electronics City",
  ...
  const site1111 = await ctx.db.insert("sites", {
    accountNumber: "1111",
    name: "Branch Office - Whitefield",
    description: "Branch office facility in Whitefield",
