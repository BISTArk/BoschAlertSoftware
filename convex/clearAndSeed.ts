// Clear all database data and reseed users
// Run with: npx convex run clearAndSeed:clearAll
// Or combined: npx convex run clearAndSeed:clearAndSeedUsers
...
// Seed users after clearing
export const seedUsers = mutation(async (ctx) => {
  console.log("👥 Seeding users...");

  // Create sample users with customer account access
  const users = [
    {
      username: "admin",
      password: "admin123",
      ...
      active: true,
      available: true,
      customerAccounts: [], // Admin sees all accounts
      createdAt: Date.now(),
    },
    {
      username: "head1",
      ...
      active: true,
      available: true,
      customerAccounts: ["1234", "5678"], // Can see multiple customers
      createdAt: Date.now(),
    },
    {
      username: "guard1",
      ...
      active: true,
      available: true,
      customerAccounts: ["1234"], // Assigned to customer 1234
      createdAt: Date.now(),
    },
    {
      username: "guard2",
      ...
      active: true,
      available: true,
      customerAccounts: ["5678"], // Assigned to customer 5678
      createdAt: Date.now(),
    },
    {
      username: "guard3",
      ...
      customerAccounts: ["1234", "5678"], // Multi-customer guard
      createdAt: Date.now(),
    },
  ];
...
// Combined: Clear all data and reseed users in one operation
export const clearAndSeedUsers = mutation(async (ctx) => {
